                        ...
                        <tr wire:key='{{ $user->id }}'
                            ...
                            <td class="ps-6 py-4">
                                <div class="grid grid-cols-3 gap-x-2">
                                    ...
                                    <a wire:click='redirectToUser({{ $user->id }})' class="w-full"><button type="button"
                                    ...
                                    <a wire:click='redirectToUpdate({{ $user->id }})' class="w-full"><button type="button"
                                    ...
                                    <button wire:click='delete({{ $user->id }})' wire:confirm='are you sure you want to delete this user?' type="button"
