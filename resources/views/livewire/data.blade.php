    ...
    @foreach ($users as $user)
        <div class="grid grid-cols-4 max-w-7xl mx-auto px-8 mb-2">
            ...
            <div class="grid grid-cols-3 gap-x-2">
                ...
                <a wire:click='redirectToUser({{$user->id}})' class="w-full"><button type="button" class="w-full bg-lime-500 hover:bg-lime-700 hover:scale-105 text-zinc-200 rounded px-2 py-1 transition ease-in-out delay-50 duration-200">View</button> </a>
