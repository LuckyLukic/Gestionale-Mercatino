    ...
    <div class="mt-6 border-t border-gray-100">
        <dl class="divide-y divide-gray-100">
            ...
            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                ...
                <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">$ {{ $totalAmount }}</dd>
            </div>
            ...
            <div id="accordionExample" x-data="{ open: false }">
                <div class="rounded-t-lg border border-neutral-200 bg-white mb-8">
                    ...
                    <div x-show="open" id="collapseOne" class="!visible" data-te-collapse-item data-te-collapse-show
